...
void Live_graphic(){
    ...
    while (true){
        DrawDecartSystem ();
        DrawGraphic (&Sqr_abc, t%100 *0.1 - 5, 0, t%10-5, RGB (rand() % 155+100, rand() % 155+100, rand() % 155+100));
        DrawGraphic (&Sqr_abc, t%100 *0.1 - 5, 0, 0, RGB (rand() % 155+100, rand() % 155+100, rand() % 155+100));
        DrawGraphic (&SinX_abc, 1, 1, 0.1*t, RGB (rand() % 155+100, rand() % 155+100, rand() % 155+100));
        DrawGraphic (&SinX_abc, t%50*0.1 - 2.5, 1, 1, RGB (rand() % 155+100, rand() % 155+100, rand() % 155+100));
